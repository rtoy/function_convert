...
of a converter is unlikely to be useful to a user.
...
The function \ttq{register\_converter} provides a user-level method to define a new converter using just the Maxima language.  A converter is specified by: (a) a name for the rule,  (b) the alias for the rule, and (c) a Maxima lambda expression implementing the conversion.  An optional documentation string may 
also be supplied.
